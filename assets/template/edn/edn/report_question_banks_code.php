...
$sql = "SELECT * FROM `question_bank` WHERE `question_user` = $user_id AND `question_class` = $clss AND `question_subject`= $subj ORDER BY `question_id`";
...
$(document).ready(function(){						
	$("#cmdPrint1").click(function() {
		...
		var divtop = $("#tbl").html();	
			...
			printWindow.document.write("<h4 id='cntr'><u>Questions Bank</u></h4>");				
